...
class MiniCourt():
    ...
    def convert_meters_to_pixels(self, meters):
        # real court width (meters) ko mini court ke drawing width (pixels) me scale karta hai
    ...
    def set_court_drawing_key_points(self):
        # ye 14 points (28 values, x,y pairs) mini court ke corners/lines define karte hai
        # sab kuch point 0 (top-left) se relative calculate ho raha, court ki real meters
        # measurements (constants.py) use karke pixel offsets nikale ja rahe
    ...
    def set_court_lines(self):
        # kaunse points ko line se connect karna hai (index pairs, drawing_key_points list ke point-number, x2 nahi hua)
        self.lines = [
            (0, 2),
            (4, 5),
            (6,7),
            ...
            (8,9),
            (10,11),
            (10,11),  # ye duplicate hai upar wali se, effect kuch nahi
            (2,3)
        ]
    ...
    def set_canvas_background_box_position(self,frame):
        ...
        # video frame ke top-right corner me white box ki jagah fix kar rahe (buffer = edge se gap)
    ...
    def draw_background_rectangle(self,frame):
        # semi-transparent white box banane ka tarika: mask use karke sirf box ke pixels blend karo
    ...
    def get_mini_court_coordinates(self,
        ...
        # trick: player ki real height (meters) ko reference bana ke pixel-to-meter
        # scale nikalte hai (jaise "ye player 1.8m ka hai aur screen pe X pixels tall hai")
        # isse camera perspective ka effect thoda handle ho jata hai
    ...
    def convert_bounding_boxes_to_mini_court_coordinates(self,player_boxes, ball_boxes, original_court_key_points ):
        ...
        for frame_num, player_bbox in enumerate(player_boxes):
            ...
            # jo player ball ke sabse paas hai usi ke height reference se ball ki mini-court position nikalenge
            ...
            for player_id, bbox in player_bbox.items():
                ...
                # player ki "current" pixel height nikalne ke liye single frame kaafi nahi (jumping/bending se galat hoga)
                # isliye ek window (pichle 20, aage 50 frames) me se max height le rahe - zyada stable estimate
                ...
                player_height = player_heights.get(player_id, constants.PLAYER_1_HEIGHT_METERS)
